...
const resourceData = [
    ...
    // ==========================================
    // MỤC 2: LITEMATICA (Bản Vẽ Máy Farm Công Trình)
    // ==========================================
    {
        id: "lite-01",
        category: "litematica",
        title: "Farm Cobblestone DonutSMP",
        description: "DonutSMP Cobblestone Farm (1 triệu cob/h), thiết kế tối ưu riêng biệt cho server DonutSMP.",
        size: "17.22 KB",
    ...
    },
    {
        ...
        description: "Máy farm đá nhỏ gọn tiết kiệm diện tích, phù hợp chơi sinh tồn cơ bản.",
        size: "2.14 KB",
    ...
    },
    {
        ...
        description: "Farm đá tự động sử dụng cơ chế phá khối của Wither, không tốn TNT.",
        size: "2.96 KB",
    ...
    },
    {
        ...
        description: "Máy farm đá tốc độ cao hiệu suất khủng 225 Cobblestone / TNT.",
        size: "2.96 KB",
        ...
        farmInfo: {
            ...
            notes: "Hiệu suất 225 đá trên mỗi khối TNT, tốc độ nổ cực đều và mượt."
        }
    },
    {
        id: "lite-05",
        ...
        description: "Cỗ máy farm đá siêu khủng 4.4M đá mỗi giờ dành cho dự án lớn.",
        size: "2.96 KB",
    ...
    },
    {
        ...
        description: "Farm đá cơ bản tích hợp sẵn khu vực base chứa đồ và kho lọc tự động.",
        size: "2.96 KB",
    ...
    },
    {
        ...
        description: "Phiên bản cơ bản, hoạt động ổn định và dễ vận hành trên mọi server.",
        size: "2.96 KB",
        ...
        farmInfo: {
            ...
            notes: "Phiên bản ổn định, thích hợp cho các server sinh tồn multiplayer."
        }
    },
    {
        id: "lite-08",
        category: "litematica",
        title: "EtZ Kelp Farm T1",
        description: "Máy farm Tảo bẹ (Kelp) tự động làm nguồn nhiên liệu đốt vô tận.",
        size: "2.96 KB",
        image: "",
        link: "https://link4m.net/wU5TZ",
        ...
        farmInfo: {
            ...
            dimensions: "15 x 15 x 12 Blocks",
            notes: "Kết hợp lò nung tự động để sản xuất Dried Kelp Block vô tận."
        }
    },
    {
        id: "lite-09",
        ...
        farmInfo: {
            ...
            dimensions: "12 x 12 x 15 Blocks",
            notes: "Hoạt động liên tục cả ngày lẫn đêm, không cần người chơi AFK trực tiếp."
        }
    },
    {
        id: "lite-10",
        category: "litematica",
        title: "Trang Trại Vàng & XP Nóc Nether",
        description: "Farm Vàng và cày cấp độ level XP từ 0 lên 100 chỉ trong vài phút tại nóc Nether.",
        size: "450 KB",
        image: "",
        link: "https://link4m.org/HmJRHJF",
        ...
        farmInfo: {
            ...
            notes: "Nên sử dụng kiếm Kéo Rộng (Sweeping Edge III) và Nhặt Đồ (Looting III)."
        }
    }
];
